...
<body class="bg-light" onload="myFunction()">
	...
	<div class="container">
		...
		<form name="loginform" method="post" action="login"
			...
			<div class="form-group ">
				<div align="center"><span class="material-icons admin"> admin_panel_settings </span></div> <label
					for="uname"><b>Enter User ID</b></label> <input type="text"
					placeholder="Enter UserId" name="uid" class="form-control" required>
				<br> <label for="psw"><b>Enter Your Password</b></label> <input
	...
	<div class="container">
		<nav class="navbar navbar-dark bg-dark fixed-bottom">
			<div class="container">
				<a href="#" class="navbar-brand">POD 13 COLLATERAL LOAN
